...
The result shows that the Engine product line in the Central warehouse in August had the highest revenue for the company, followed closely by the Frame & body product line for the same month and warehouse.



I analyzed wholesale motorcycle part sales across three warehouses to calculate net revenue trends by product line and month.
Using SQL aggregation and filtering, I determined that engine sales in the Central warehouse during August generated the highest revenue.
